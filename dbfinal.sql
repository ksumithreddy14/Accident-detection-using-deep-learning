...
insert  into `upload`(`id`,`image_data`,`current_location`,`our_location`) values (3,'static/uploads/Pwrh.jpg','ameerpet','kukatpally'),(4,'static/uploads/JayQ.jpg','ameerpet','kukatpally'),(5,'static/uploads/zyvF.jpg','ameerpet','HUDA Colony');
